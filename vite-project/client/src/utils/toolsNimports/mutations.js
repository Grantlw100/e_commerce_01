...
export const CHANGE_DARK_MODE = gql`
  mutation ChangeDarkMode($id: ID!, $darkMode: Boolean!) {
    changeDarkMode(id: $id, darkMode: $darkMode) {
      id
      darkMode
    }
  }
...
export const SEND_NOTIFICATION_TO_ALL = gql`
  mutation SendNotificationToAll($input: NotificationInput!) {
    sendNotificationToAll(input: $input) {
      id
      user {
        id
      }
...
export const SEND_NOTIFICATION_TO_USER = gql`
  mutation SendNotificationToUser($userId: ID!, $input: NotificationInput!) {
    sendNotificationToUser(userId: $userId, input: $input) {
      id
      user {
        id
      }
...
export const SEND_USER_ALERT_TO_ALL = gql`
  mutation SendUserAlertToAll($input: UserAlertInput!) {
    sendUserAlertToAll(input: $input) {
      id
      user {
        id
      }
...
export const SEND_USER_ALERT_TO_USER = gql`
  mutation SendUserAlertToUser($userId: ID!, $input: UserAlertInput!) {
    sendUserAlertToUser(userId: $userId, input: $input) {
      id
      user {
        id
      }
...
export const CREATE_CONTENT = gql`
  mutation CreateContent($input: ContentInput!, $files: [Upload!]) {
    createContent(input: $input, files: $files) {
      id
      title
      content
      contentType
...
export const UPDATE_CONTENT = gql`
  mutation UpdateContent($id: ID!, $input: ContentInput!, $newFiles: [Upload], $deleteFiles: [String]) {
    updateContent(id: $id, input: $input, newFiles: $newFiles, deleteFiles: $deleteFiles) {
      id
      title
      content
      contentType
...
export const CREATE_REVIEW = gql`
    mutation CreateReview($productId: ID!, $userId: ID!, $input: ReviewInput!, $files: [Upload]) {
    createReview(productId: $productId, userId: $userId, input: $input, files: $files) {
      id
      rating
      text
      reviewImages
...
export const UPDATE_REVIEW = gql`
    mutation UpdateReview($id: ID!, $input: ReviewUpdateInput!, $newFiles: [Upload], $deleteFiles: [String]) {
    updateReview(id: $id, input: $input, newFiles: $newFiles, deleteFiles: $deleteFiles) {
      id
      rating
      text
      reviewImages
...
export const ADD_ITEM_TO_CART = gql`
  mutation addItemToCart($userId: ID!, $input: CartItemInput!) {
...
export const SAVE_GLOBAL_STATE = gql`
  mutation SaveGlobalState($state: String!) {
    saveGlobalState(state: $state)
  }
`;

export const LOAD_GLOBAL_STATE = gql`
  query LoadGlobalState {
    loadGlobalState
  }
`;
